...
module.exports = {
  ...
  magento: {
    url: process.env.MAGENTO_URL || "https://magento.test/rest/",
    consumerKey:
      process.env.MAGENTO_CONSUMER_KEY || "b78xou33aglayfhu3uitbnslvz7qq0zz",
    consumerSecret:
      process.env.MAGENTO_CONSUMER_SECRET || "acplcvma8g5nk47uxob2y3mmxhm8103u",
    accessToken:
      process.env.MAGENTO_ACCESS_TOKEN || "eg5mpu43mgum13g0i75njfn7g0p6sa0n",
    accessTokenSecret:
      process.env.MAGENTO_ACCESS_TOKEN_SECRET ||
      "lrcwuj8il5zg0uf4fnv1rs4ufupuunmr",
